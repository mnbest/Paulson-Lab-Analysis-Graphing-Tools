...
excel_file <- "~/Desktop/PSP HEAT MAP DATA 40X_TRIM46_summary_table_all_classes.xlsx"

# Expected row and column order
expected_rows <- c(
  "NPC 1", "NPC 2", "NPC 4", "NPC 5", "NPC 6", "NPC 9", "NPC 10",
  "NPC 11", "NPC 12", "PO 1", "PO 9", "PO 2", "PO 3", "PO 5", "PO 10",
  "PO 8", "POD 16", "POD 17", "POD 18", "POD 5", "POD 19", "POD 20", "POD 21"
)

expected_cols <- c("Full AIS", "Partial AIS", "Combined AIS", "Artifact")
